...
namespace Fp.Utility.Stateless
{
    public partial class StateMachine<TState, TTrigger>
    {
        ...
        public class StateConfiguration
        {
            ...
            /// <summary>
            ///     Add an internal transition to the state machine. An internal action does not cause the Exit and Entry actions to be
            ///     triggered, and does not change the state of the state machine
            /// </summary>
            ...
            /// <returns></returns>
            public StateConfiguration InternalTransitionIf(
                TTrigger trigger,
            ...
            /// <param name="guardDescription">A description of the guard condition</param>
            /// <returns></returns>
            public StateConfiguration InternalTransitionIf<TArg0>(
                TTrigger trigger,
                Func<object[], bool> guard,
                Action<Transition> internalAction,
                string guardDescription = null)
            {
                if (internalAction == null)
                {
            ...
            /// <returns></returns>
            public StateConfiguration InternalTransitionIf<TArg0>(
                TriggerWithParameters<TArg0> trigger,
                Func<TArg0, bool> guard,
                Action<TArg0, Transition> internalAction,
                string guardDescription = null)
            {
                if (internalAction == null)
                {
                ...
                _representation.AddTriggerBehaviour(new InternalTriggerBehaviour.Sync(trigger.Trigger, TransitionGuard.ToPackedGuard(guard),
                                                                                      (t, args) => internalAction(
                                                                                          ParameterConversion.Unpack<TArg0>(args, 0), t), guardDescription));
                return this;
            }
            ...
            /// <param name="internalAction">The action performed by the internal transition</param>
            /// <returns></returns>
            public StateConfiguration InternalTransition<TArg0, TArg1>(
                TriggerWithParameters<TArg0, TArg1> trigger,
            ...
            /// <param name="guardDescription">A description of the guard condition</param>
            /// <returns></returns>
            public StateConfiguration InternalTransitionIf<TArg0, TArg1>(
                TriggerWithParameters<TArg0, TArg1> trigger,
                Func<object[], bool> guard,
                Action<TArg0, TArg1, Transition> internalAction,
                string guardDescription = null)
            ...
            /// <param name="guardDescription">A description of the guard condition</param>
            /// <returns></returns>
            public StateConfiguration InternalTransitionIf<TArg0, TArg1, TArg2>(
                TriggerWithParameters<TArg0, TArg1, TArg2> trigger,
                Func<object[], bool> guard,
                Action<TArg0, TArg1, TArg2, Transition> internalAction,
                string guardDescription = null)
            {
                if (internalAction == null)
                {
            ...
            public StateConfiguration InternalTransitionIf<TArg0, TArg1, TArg2>(
                TriggerWithParameters<TArg0, TArg1, TArg2> trigger,
                Func<TArg0, TArg1, TArg2, bool> guard,
                Action<TArg0, TArg1, TArg2, Transition> internalAction,
                string guardDescription = null)
            {
                if (internalAction == null)
                ...
                _representation.AddTriggerBehaviour(new InternalTriggerBehaviour.Sync(trigger.Trigger, TransitionGuard.ToPackedGuard(guard), (t, args) =>
                                                                                          internalAction(
                                                                                              ParameterConversion.Unpack<TArg0>(args, 0),
                                                                                              ParameterConversion.Unpack<TArg1>(args, 1),
                                                                                              ParameterConversion.Unpack<TArg2>(args, 2), t),
            ...
            /// <param name="internalAction">The action performed by the internal transition</param>
            /// <returns></returns>
            public StateConfiguration InternalTransition<TArg0, TArg1, TArg2>(
                TriggerWithParameters<TArg0, TArg1, TArg2> trigger,
                Action<TArg0, TArg1, TArg2, Transition> internalAction)
            {
                return InternalTransitionIf(trigger, t => true, internalAction);
            ...
            /// <param name="guardDescription">Guard description</param>
            /// <returns>The reciever.</returns>
            public StateConfiguration PermitIf<TArg0>(
                TriggerWithParameters<TArg0> trigger,
            ...
            public StateConfiguration PermitIf<TArg0>(
                TriggerWithParameters<TArg0> trigger,
                TState destinationState,
                params Tuple<Func<TArg0, bool>, string>[] guards)
            {
                EnforceNotIdentityTransition(destinationState);
            ...
            /// <param name="guardDescription">Guard description</param>
            /// <returns>The reciever.</returns>
            public StateConfiguration PermitIf<TArg0, TArg1>(
                TriggerWithParameters<TArg0, TArg1> trigger,
                TState destinationState,
                Func<TArg0, TArg1, bool> guard,
                string guardDescription = null)
            ...
            public StateConfiguration PermitIf<TArg0, TArg1>(
                TriggerWithParameters<TArg0, TArg1> trigger,
                TState destinationState,
                params Tuple<Func<TArg0, TArg1, bool>, string>[] guards)
            {
                EnforceNotIdentityTransition(destinationState);
            ...
            /// <param name="guardDescription">Guard description</param>
            /// <returns>The reciever.</returns>
            public StateConfiguration PermitIf<TArg0, TArg1, TArg2>(
                TriggerWithParameters<TArg0, TArg1, TArg2> trigger,
                TState destinationState,
                Func<TArg0, TArg1, TArg2, bool> guard,
                string guardDescription = null)
            ...
            public StateConfiguration PermitIf<TArg0, TArg1, TArg2>(
                TriggerWithParameters<TArg0, TArg1, TArg2> trigger,
                TState destinationState,
                params Tuple<Func<TArg0, TArg1, TArg2, bool>, string>[] guards)
            {
                EnforceNotIdentityTransition(destinationState);
            ...
            /// <param name="guardDescription">Guard description</param>
            /// <returns>The reciever.</returns>
            public StateConfiguration PermitReentryIf<TArg0, TArg1>(
                TriggerWithParameters<TArg0, TArg1> trigger,
                Func<TArg0, TArg1, bool> guard,
                string guardDescription = null)
            {
            ...
            /// <param name="guardDescription">Guard description</param>
            /// <returns>The reciever.</returns>
            public StateConfiguration PermitReentryIf<TArg0, TArg1, TArg2>(
                TriggerWithParameters<TArg0, TArg1, TArg2> trigger,
                Func<TArg0, TArg1, TArg2, bool> guard,
                string guardDescription = null)
            {
            ...
            /// </param>
            /// <returns>The receiver.</returns>
            public StateConfiguration IgnoreIf<TArg0, TArgo1>(
                TriggerWithParameters<TArg0, TArgo1> trigger,
                Func<TArg0, TArgo1, bool> guard,
                string guardDescription = null)
            {
                _representation.AddTriggerBehaviour(
                    new IgnoredTriggerBehaviour(
            ...
            /// </param>
            /// <returns>The receiver.</returns>
            public StateConfiguration IgnoreIf<TArg0, TArg1>(
                TriggerWithParameters<TArg0, TArg1> trigger,
                params Tuple<Func<TArg0, TArg1, bool>, string>[] guards)
            {
                _representation.AddTriggerBehaviour(
            ...
            /// </param>
            /// <returns>The receiver.</returns>
            public StateConfiguration IgnoreIf<TArg0, TArg1, TArg2>(
                TriggerWithParameters<TArg0, TArg1, TArg2> trigger,
                Func<TArg0, TArg1, TArg2, bool> guard,
                string guardDescription = null)
            {
            ...
            /// <param name="entryActionDescription">Action description.</param>
            /// <returns>The receiver.</returns>
            public StateConfiguration OnEntryFrom<TArg0>(
                TriggerWithParameters<TArg0> trigger,
            ...
            /// <param name="entryActionDescription">Action description.</param>
            /// <returns>The receiver.</returns>
            public StateConfiguration OnEntryFrom<TArg0, TArg1>(
                TriggerWithParameters<TArg0, TArg1> trigger,
            ...
            public StateConfiguration OnEntryFrom<TArg0, TArg1, TArg2>(
                TriggerWithParameters<TArg0, TArg1, TArg2> trigger,
                Action<TArg0, TArg1, TArg2, Transition> entryAction,
                string entryActionDescription = null)
            {
                if (trigger == null)
                {
            ...
            /// <returns>The reciever.</returns>
            public StateConfiguration PermitDynamic(
                TTrigger trigger,
                    ...
                    new DynamicTriggerBehaviour(trigger,
                                                ...
                                                DynamicTransitionInfo.Create(trigger,
                                                                             ...
                                                                             InvocationInfo.Create(
                                                                                 destinationStateSelector, destinationStateSelectorDescription),
            ...
            /// <returns>The reciever.</returns>
            /// <typeparam name="TArg0">Type of the first trigger argument.</typeparam>
            public StateConfiguration PermitDynamic<TArg0>(
                TriggerWithParameters<TArg0> trigger,
            ...
            /// <typeparam name="TArg0">Type of the first trigger argument.</typeparam>
            /// <typeparam name="TArg1">Type of the second trigger argument.</typeparam>
            public StateConfiguration PermitDynamic<TArg0, TArg1>(
                TriggerWithParameters<TArg0, TArg1> trigger,
            ...
            /// <param name="possibleDestinationStates">Optional list of possible target states.</param>
            /// <returns>The reciever.</returns>
            public StateConfiguration PermitDynamicIf(
                TTrigger trigger,
                Func<TState> destinationStateSelector,
                Func<bool> guard,
                string guardDescription = null,
            ...
            /// <returns>The reciever.</returns>
            /// <typeparam name="TArg0">Type of the first trigger argument.</typeparam>
            public StateConfiguration PermitDynamicIf<TArg0>(
                TriggerWithParameters<TArg0> trigger,
                Func<TArg0, TState> destinationStateSelector,
                Func<bool> guard,
                string guardDescription = null,
            ...
            {
                return PermitDynamicIf(trigger, destinationStateSelector, null, new Tuple<Func<bool>, string>[0]);
            }
            ...
            /// <typeparam name="TArg0">Type of the first trigger argument.</typeparam>
            /// <typeparam name="TArg1">Type of the second trigger argument.</typeparam>
            public StateConfiguration PermitDynamicIf<TArg0, TArg1>(
                TriggerWithParameters<TArg0, TArg1> trigger,
                Func<TArg0, TArg1, TState> destinationStateSelector,
                Func<bool> guard,
                string guardDescription = null,
            ...
            public StateConfiguration PermitDynamicIf<TArg0, TArg1>(
                TriggerWithParameters<TArg0, TArg1> trigger,
                Func<TArg0, TArg1, TState> destinationStateSelector,
                Tuple<Func<TArg0, TArg1, bool>, string>[] guards,
                DynamicStateInfos possibleDestinationStates = null)
            {
                if (trigger == null)
                {
            ...
            public StateConfiguration PermitDynamicIf<TArg0, TArg1, TArg2>(
                TriggerWithParameters<TArg0, TArg1, TArg2> trigger,
                Func<TArg0, TArg1, TArg2, TState> destinationStateSelector,
                Tuple<Func<TArg0, TArg1, TArg2, bool>, string>[] guards,
                DynamicStateInfos possibleDestinationStates = null)
            {
                if (trigger == null)
                {
            ...
            /// <summary>
            ///     Adds internal transition to this state. When entering the current state the state machine will look for an initial
            ///     transition, and enter the target state.
            /// </summary>
            ...
            public StateConfiguration InitialTransition(TState targetState)
            {
                if (_representation.HasInitialTransition)
                {
                    throw new InvalidOperationException(
                        $"This state has already been configured with an inital transition ({_representation.InitialTransitionTarget}).");
                }
            ...
            private StateConfiguration InternalPermitDynamicIf(
                TTrigger trigger,
